...
1. TPS6522x-Q1: Four Buck Converters, Three Linear Regulators (LDOs), Three Voltage Monitors (VMONs), Six General-Purpose I/Os (GPIOs), ADC, Watchdog, and Error Signal Monitor (ESM)
...
The TPS6522x-Q1 watchdog module supports configuration and status reporting for PMIC watchdog features, including trigger mode, fail count threshold, and Q&A mode.
